...
def main() -> int:
    ...
    try:
        ...
        steps.append(_run_step("smoke_metadata", [npm_cmd, "run", "smoke:metadata"], DESKTOP_ROOT))
        steps.append(_run_step("smoke_scraper", [npm_cmd, "run", "smoke:scraper"], DESKTOP_ROOT))
